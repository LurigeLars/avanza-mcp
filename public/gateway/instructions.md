...
- On snapshot continuation calls, omit product/filter arguments or repeat the exact original values; the stored snapshot is authoritative and is not refetched.
